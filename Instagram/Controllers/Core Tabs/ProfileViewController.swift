...
class ProfileViewController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        // Headers
        collectionView?.register(ProfileInfoHedaerCollectionReusableView.self,
                                 forSupplementaryViewOfKind: UICollectionView.elementKindSectionHeader,
                                 withReuseIdentifier: ProfileInfoHedaerCollectionReusableView.identifier)
...
//        return userPosts.count
    ...
    func collectionView(_ collectionView: UICollectionView, viewForSupplementaryElementOfKind kind: String, at indexPath: IndexPath) -> UICollectionReusableView {
        ...
        let profileHeader = collectionView.dequeueReusableSupplementaryView(ofKind: kind,
                                                                     withReuseIdentifier: ProfileInfoHedaerCollectionReusableView.identifier,
                                                                     for: indexPath) as! ProfileInfoHedaerCollectionReusableView
...
extension ProfileViewController: ProfileInfoHedaerCollectionReusableViewDelegate {
    ...
    func profileHeaderDidTapFollowersButton(_ header: ProfileInfoHedaerCollectionReusableView) {
        ...
        for x in 0..<10 {
            mockData.append(UserRelationship(username: "@jay", name: "Jay Lee", type: x % 2 == 0 ? .following : .not_following))
        }
