...
//  Instagram
//
//  Created by Jay Lee on 2021/04/13.
//
...
class UserFollowTableViewCell: UITableViewCell {
    ...
    override func layoutSubviews() {
        ...
        let buttonWidth = contentView.width > 500 ? 250.0 : contentView.width/3
        ...
        usernameLable.frame = CGRect(x: profileImageView.right+5,
                                     y: nameLabel.bottom,
                                     width: contentView.width-8-profileImageView.height-buttonWidth, height: labelHeight)
    }
